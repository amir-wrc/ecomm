        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#settings" data-toggle="tab">Product - Edit</a></li>
            </ul>
            <div class="tab-content">
              
              <div class="tab-pane active" id="settings">
                <form name="frmProduct" method="post" action="{{ url('admin/products/update/'.$product->id)}}" class="form-horizontal" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="code" placeholder=" Product Code" name="code" value="{{ $product->code }}">
                  ...
                  <div class="form-group {{ $errors->has('short_description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      <textarea name="short_description" id="short_description" class="form-control" placeholder="Product Short Description">{{ $product->short_description }}</textarea>
                  ...
                  <div class="form-group {{ $errors->has('full_description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      <textarea name="full_description" id="full_description" class="form-control" placeholder="Product Full Description">{{ $product->long_description }}</textarea>
                  ...
                  <div class="form-group {{ $errors->has('sub_category_id') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      ...
                      @foreach($sub_categories as $key=>$value)
                        <option value="{{$key}}" {{ in_array($key, $categories_array) ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                      </select>
                  ...
                  <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      ...
                      <img src="{{ url('uploads/product/' .$product->image)}}" alt="{{$product->image}}" class="img-responsive">
                    </div>
